...
### 9. leetcode 80 删除有序数组中的重复项II（中等题）
...
<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220202183949475.png" alt="image-20220202183949475" style="zoom:80%;" />
...
<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220202184142844.png" alt="image-20220202184142844" style="zoom:67%;" />
...
##### 14. leetcode357 计算各个位数不同的数字

<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220106210620054.png" alt="image-20220106210620054" style="zoom:67%;" />
...
class Solution {
    public int countNumbersWithUniqueDigits(int n) {
        ...
        // 这个真是做出了高中题的感觉
        // 设f[i]为[10^(i-1),10^i)之间的重复数字
        // 重复的才好做  这就是高中的排列组合问题
        // 如果前i-1位沿用了之前的重复数字则f[i]+=f[i-1]*10(在低位加0-9)
        // 如果前i-1位置没有沿用之前的重复数字，则要算出前i-1位到底有多少个不重复数字
        // 由于最高位不能为0 所以有9种 其余i-2位置有10种
        // 所以总共有排列数9*10^(i-2)
        // 不重复数有9*10^(i-2)-f[i-1]
        // 则对于最后一位只需要对前i-1位置的任意一个相同即可
        // 所以 f[i]+=(9*10^(i-2)-f[i-1])*(i-1);
        if(n==0){
            return 1;
        }
        ...
        f[1]=0;
        for(int i=2;i<n+1;i++){
            f[i]=f[i-1]*10+(9*getPower(10,i-2)-f[i-1])*(i-1);
        }
...
善于对前面已经存在的情况进行划分，划分各种类进行分类讨论，很类似决策问题。

这一题排列问题，高中知识。

##### 15 leetcode 368 最大整除子集

<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220107221716366.png" alt="image-20220107221716366" style="zoom:67%;" />
...
class Solution {
    public List<Integer> largestDivisibleSubset(int[] nums) {
        ...
        // 肯定先要排个序
        // 假设前i个数的最大子集长度是f[i]，且必须以第i个数结尾的
        // 这个集成了坐标动态规划和划分型动态规划的特点
        Arrays.sort(nums);
        int n = nums.length;
        int[] f = new int[n + 1];
        f[0] = 0;
        ...
        for (int i = 2; i < n + 1; i++) {
            ...
            for (int j = 1; j < i; j++) {
                if (nums[i - 1] % nums[j - 1] == 0) {
                    // f[i]=max(f[j]+1)(j属于[1,i),且当且仅当nums[i - 1] % nums[j - 1] == 0)
...
<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220109170026731.png" alt="image-20220109170026731" style="zoom:67%;" />
...
////////////////////////////////////////////////////////////////////////
        ...
        // 要确认能够拼出的最大值是sum(nums)
        // 最小能够拼出的小值为-sum(nums)
        // 所以要开的数组为
        int[][] f = new int[len][2 * sum + 1];
        // 其中f[len][2*sum+1]表示前len个数拼成sum的个数
        // 所以相差的是sum+1
...
#### 1. leetcode 21 合并两个有序的链表

<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220109172954934.png" alt="image-20220109172954934" style="zoom:50%;" />
...
#### 3. leetcode 160 相交的链表

![image-20220109175453923](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220109175453923.png)

==a走完就走b的路，b走完就走a的路，总有一天会相遇，如果相交的话==
...
public class Solution {
    public ListNode getIntersectionNode(ListNode headA, ListNode headB) {
        ...
        while (l1 != l2) {
            l1 = (l1 == null) ? headB : l1.next;//若有交点必会相遇A头--->A尾--->B头--->B尾
            l2 = (l2 == null) ? headA : l2.next;//B头--->B尾--->A头--->A尾
        }
        return l1;
    }
}
...
#### 9. leetcode 876 链表的中间节点

<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220121231413508.png" alt="image-20220121231413508" style="zoom:67%;" />
...
#### 1. leetcode 83 从有序链表中删除重复节点，重复节点可以留下一次
...
#### 2. leetcode 82 从有序链表中删除重复节点，且重复节点一个不留
...
class Solution {
    public ListNode deleteDuplicates(ListNode head) {
        ...
        // 如果当前 cur.next 与 cur.next.next对应的元素相同，
        ...
        //
        //如果当前 cur.next 与cur.next.next 对应的元素不相同，那么说明链表中只有一个元素值为 cur.next 的节点，
        // 那么我们就可以将cur 指向 cur.next。
        //
...
<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220117212443572.png" alt="image-20220117212443572" style="zoom:50%;" />
...
class Solution {
    public ListNode reverseBetween(ListNode head, int left, int right) {
       // 因为头节点有可能发生变化，使用虚拟头节点可以避免复杂的分类讨论
        ...
        // 第 3 步：从 prev 再走 right - left + 1 步，来到 right 节点
        ListNode rightNode=prev;
        for(int i=0;i<right-left+1;i++){
            rightNode=rightNode.next;
        }
        
        // 第 4步 拿到right的下一个节点cur
...
<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220118212024163.png" alt="image-20220118212024163" style="zoom:67%;" />
...
public class Solution {
    ...
    public ListNode detectCycle(ListNode head) {
        ...
        // 1. 假设相遇时 slow走了m圈
        // fast走了n圈
        // 则a+n(b+c)+b=2[m(b+c)+b+a]
        // 即n(b+c)=2m(b+c)+a+b
        // 所以n>=2m
        // 即在环里的速度一定fast大于等于slow的两倍

        // 2. 所以slow刚进入圆环，并走了距离b时就会相遇
        // a+n(b+c)+b=2(a+b)
        // nb+nc=a+b
...
<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220121231521338.png" alt="image-20220121231521338" style="zoom:67%;" />
...
class Solution {
    public ListNode partition(ListNode head, int x) {
        ...
        // 哑结点用来记住原来位置的
        ListNode dumyLessNode=new ListNode();
        dumyLessNode=less;

        // 哑结点用来记住原来位置的
        ListNode dumyMoreNode=new ListNode();
        dumyMoreNode=more;
        ...
        while(cur!=null){
            if(cur.val<x){
                // 这第一次的less.next表示的是实际的less的起始节点
                // 这第一次的less.next表示的是实际的less的起始节点
                less.next=cur;
                less=less.next;
            }else{
                // 同理这第一次的more.next实际的more的起始节点
                more.next=cur;
                more=more.next;
            }
            cur=cur.next;
        ...
        // 为什么要这一个，没有这一个为啥不能完全通过  
        // 大概是为了验证的时候能判断一个链表的结束吧
        // 大概是为了验证的时候能判断一个链表的结束吧
        more.next = null;
        // 小的迭代的next等于哑结点more
        less.next = dumyMoreNode.next;
        // 注意  返回的是dumyLessNode.next 
        // 因为记住的是less最初始的位置  而最初始的位置与所给链表没有关系
        return dumyLessNode.next;
    }
}
```
...
<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220121231705498.png" alt="image-20220121231705498" style="zoom:67%;" />
...
class Solution {
   public void reorderList(ListNode head) {
        ...
        // 1. 找到中间节点
        // 这里的中间节点是奇数节点的5个节点的第三个节点 6个节点的第三个节点
        // 总之控制后面的那一半比前一部分小1或者等于
        ListNode middleNode = middleNode(head);
   
        // 2. 所以需要将中间节点（不含）之后的节点进行逆序
        ...
        while(reversedNode!=null){
            ...
            // 指定后一个的next
            reversedNode.next=headNext;

            // 迭代next
            // 如果总共的链表长度是5个数，前面的链表是3个数  那么这里已经拿到第三个数了
            // 而后面的链表拿到的第三个数是空  
            // 所以会跳出循环，直接将第三个数的next置为空即可
            // 如果总共长度是6，则都能循环三次，在第四次时 head指向的下一个其实就是最后一个了
            // 所以同样只需要将head的next置为空即可
            head=headNext;
...
class Solution {
   public ListNode insertionSortList(ListNode head) {
        ...
        //
        // 1. 创建哑节点 dummyHead，令 dummyHead.next = head。
        ...
        while (curr != null) {
            //
            // 4.1 若 lastSorted.val <= curr.val，
            // 说明 curr 应该位于 lastSorted 之后，
            // 将 lastSorted 后移一位
            if (lastSorted.val <= curr.val) {
                // 注意后移一位，不是说将curr复制给lastSorted
                lastSorted = lastSorted.next;
            } else {
                //
                // 4.2 否则，从链表的头节点开始往后遍历链表中的节点，寻找插入 curr 的位置。
                // 只能从前往后
                ListNode prev = dummyHead;
                while (prev.next.val <= curr.val) {
                    // 如果小于当前的值 则说明前面的不需要断开，不需要动
                    // 这一步是找到插入的位置
                    prev = prev.next;
                }
                // 5. 找到大于curr的节点prev.next
                // 移动我们的lastSorted,因为curr需要落位了
                lastSorted.next = curr.next;
                // ...->prev->(大于curr的值)->...>lastSorted->curr.next
                //  先prev.next的值放到要插入的curr之后，因为我们需要查到(大于curr的值)之前
                curr.next = prev.next;
                prev.next = curr;
            }
...
#### 10. leetcode 328  奇偶链表

<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220126232547666.png" alt="image-20220126232547666" style="zoom:67%;" />
...
public class Solution {
    public ListNode oddEvenList(ListNode head) {
        ...
        // 1. 迭代节点的生成
        // 奇数节点的迭代节点  用于生成奇数节点链表
        ListNode oddNode=new ListNode();
        // 偶数节点的迭代节点  用于生成偶数节点链表
        ListNode evenNode=new ListNode();

        // 2. 哑节点的生成 用于不忘初心
        ListNode dummyOddNode=oddNode;
        ListNode dummyEvenNode=evenNode;

        // 3. 整个链表迭代节点
        ListNode cur=head;
        while(cur!=null){
            // 奇数节点链表生成
            // 注意奇数节点的有效开始位置 是dummyOddNode.next
            oddNode.next =cur;
            oddNode=oddNode.next;
            if (cur.next!=null){
                // 同样 偶数节点的有效开始位置是 dummyEvenNode.next
...
#### 11. leetcode 1721 交换链表中的节点

<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220127220219304.png" alt="image-20220127220219304" style="zoom:67%;" />
...
![image-20220129190710244](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220129190710244.png)
...
<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220129190751639.png" alt="image-20220129190751639" style="zoom:80%;" />
...
![image-20220129190843585](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220129190843585.png)
...
![image-20220129190931619](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220129190931619.png)

#### 5. leetcode 617 合并二叉树

<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220129190006522.png" alt="image-20220129190006522" style="zoom:50%;" />
...
![image-20220129191000878](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220129191000878.png)

#### 6. leetcode 112 路径总和

<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220130184223703.png" alt="image-20220130184223703" style="zoom: 67%;" />
...
![image-20220130190557043](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220130190557043.png)

#### 7. leetcode 437 路径总和III

<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220130184515357.png" alt="image-20220130184515357" style="zoom:80%;" />
...
![image-20220130190735664](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220130190735664.png)

#### 8. leetcode 111 二叉树的最小深度

<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220130184855709.png" alt="image-20220130184855709" style="zoom:67%;" />
...
![image-20220130190757095](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220130190757095.png)

#### 9. leetcode 572 子树

<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220130190129313.png" alt="image-20220130190129313" style="zoom:80%;" />
...
![image-20220130190823936](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220130190823936.png)
...
![image-20220130190840741](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220130190840741.png)

#### 11. leetcode 404 左叶子之和

<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220131182103733.png" alt="image-20220131182103733" style="zoom:67%;" />
...
![image-20220131182213772](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220131182213772.png)

#### 12. leetcode 687 最长同值路径

<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220131182746452.png" alt="image-20220131182746452" style="zoom:67%;" />
...
![image-20220131182809426](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220131182809426.png)

#### 13. leetcode 671 二叉树中第二小的节点

<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220131183100552.png" alt="image-20220131183100552" style="zoom:67%;" />
...
#### ![image-20220131184533187](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220131184533187.png)

#### 14. leetcode 337 打家劫舍III

<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220131183352211.png" alt="image-20220131183352211" style="zoom:67%;" />
...
![image-20220131183434500](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220131183434500.png)

#### 15. leetcode 98 验证二叉搜索树

<img src="%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220207225523577.png" alt="image-20220207225523577" style="zoom:80%;" />
...
![image-20220201220024523](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220201220024523.png)



![image-20220201220108112](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220201220108112.png)

![image-20220201220156860](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220201220156860.png)
...
![image-20220201220416271](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220201220416271.png)
...
![image-20220201220524248](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220201220524248.png)
...
![image-20220201220811954](%E4%B8%8D%E7%84%B6%E6%B0%B8%E8%BF%9C%E8%BF%87%E4%B8%8D%E5%8E%BB.assets/image-20220201220811954.png)
